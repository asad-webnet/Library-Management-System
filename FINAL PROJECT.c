...
void deletebooks(void){
    ...
    if(flag)
        ...
        printf("\nNo record found associated with this book in our database.\n\n");
    fclose(fp);
    fclose(ft);
    remove("Project.dat");
    rename("test.dat","Project.dat");
    printf("\n\nWant to delete another book record (y/n) ? : ");
    ch=getche();
    if(ch == 'y')
        deletebooks();
    else {
        printf("\n\nReturning to office menu in 3  seconds.\n");
        delay(3);
        officedisplay();
    }
}
void searchbooks(void){
    ...
    case 2:
    {
        ...
        gotoxy(53,16);
        printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
        gotoxy(53,17);printf("\xB2");  gotoxy(71,17);printf("\xB2");
        gotoxy(53,18);
        printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
